  ...
  return (
    ...
    >
      ...
      <CodeWindow
        ...
        copyText="GH_TOKEN=... node scripts/score-seeds.mjs --repo <org>/<repo> --pr <n> --json"
      >
        <span className="tk-prompt">$</span> <span className="tk-white">GH_TOKEN=... node scripts/score-seeds.mjs --repo acme/pilot --pr 4 --json</span>{"\n"}
