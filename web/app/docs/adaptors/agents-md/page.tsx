  ...
  return (
    ...
    >
      ...
      <CodeWindow title="AGENTS.md structure">
        ...
        <span className="tk-dim">&lt;!-- Redline v{version} · profile: web-react · stacks: javascript, react --&gt;</span>{"\n"}
      ...
      <ol>
        <li>Onboard the repo with <code>npx redlinegate init</code> — the pull request it opens adds <code>AGENTS.md</code> with the profile&apos;s stacks.</li>
