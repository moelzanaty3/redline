...
export const STANDARDS: RegistryEntry[] = [
  ...
  { slug: "vue", title: "Vue", file: "standards/stacks/vue.md", description: "Vue 3 and Nuxt — reactivity that silently stops updating, v-html, SSR state leaks." },
  { slug: "svelte", title: "Svelte / SvelteKit", file: "standards/stacks/svelte.md", description: "Svelte 4 and 5 plus SvelteKit — runes, stores, and what load runs where." },
  { slug: "dom", title: "Browser / DOM", file: "standards/stacks/dom.md", description: "Framework-free browser code — the sinks and leaks a framework normally hides." },
...
export const SCRIPTS: RegistryEntry[] = [
  ...
  { slug: "build-correlation", title: "build-correlation.mjs", file: "scripts/build-correlation.mjs", description: "Research: whether ignoring a finding cost anything. Refuses to report a rate the sample does not support." },
...
export const SEEDS: RegistryEntry[] = [
  ...
  { slug: "angular", title: "angular", file: "seeded/angular/seeded-violations.component.ts", description: "Seeded Angular defects — a disabled sanitiser, dead subscriptions, an open redirect, work in a template binding." },
  { slug: "vue", title: "vue", file: "seeded/vue/SeededViolations.vue", description: "Seeded Vue defects — reactivity lost on destructure, v-html, module-scope state shared across SSR requests." },
  { slug: "svelte", title: "svelte", file: "seeded/svelte/SeededViolations.svelte", description: "Seeded Svelte and SvelteKit defects — {@html}, private env in shared code, secrets in a universal load." },
  { slug: "dom", title: "dom", file: "seeded/dom/seeded-violations.js", description: "Seeded browser defects — innerHTML sinks, postMessage with no origin check, listeners that outlive the widget." },
